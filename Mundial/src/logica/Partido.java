...
public class Partido {
	...
	private int extra;
//	private String[] resultado = new String[8];
	
	

	@Override
	public String toString() {
		return "Partido [tiempo=" + duracion + "]";
	}

	public Partido( Pais pais1, Pais pais2, int duracion) {
	super();
	this.id = id++;
	this.pais1 = pais1;
	this.pais2 = pais2;
...
//	
//	extra = (int) (Math.random()*10 );
//	duracion = duracion + entra;
//	Partido partido = new Partido(pais1 ,pais2, duracion);
	
	public LinkedList<Pais> jugarFaceGrupos(Pais pais1, Pais pais2, Pais pais3, Pais pais4){
		
		//	listaOctavos.add(ganadores);
